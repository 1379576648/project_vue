  ...
  <div style="width: 100%;">
              ...
              >
                ...
                <el-table-column  label="商品名称" align="center" width="320px">
                  <div class="ant_sp">
                    ...
                    <el-button size="small"  @click="selectGoodsDialog = true">选择商品</el-button>
                  </div>
                </el-table-column>
    ...
    <div style="margin-top: 10px;height: 230px;width: 100%;background-color: white">
      ...
      <div style="padding: 10px;width: 100%;height: 60px;">
        <el-button type="primary" style="float: right;margin-left: 10px;margin-right: 10px">保存并入库</el-button>
        <el-button style="float: right">保存</el-button>
        <el-button style="float: right" @click="this.selectGoodsDialog===true">取消</el-button>
      </div>
    </div>
  </div>
