<template>
  <div class="max">
      ...
      <el-row :gutter="24">
          ...
          <el-col :span="6"></el-col>
          <el-col :span="6">
              <el-input v-model="likeinput" size="small" placeholder="编号/名称/电话" @keyup.enter.native="select()" style="width:50%;margin-left:40px;">
                  <template #append>
                      <el-button size="small" @click="selectAll()" :icon="icon.search" />
                  </template>
              </el-input>
